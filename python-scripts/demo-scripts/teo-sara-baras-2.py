...
tts.say('Hola Sara. Soy Teo. El humanoide más flamenco de la Universidad Carlos Tercero de Madrid. ')
...
tts.say('Quiero que sepas que soy tu mayor fan. Aqui me ves, aprendiendo a bailar flamenco como tu.')
...
tts.say('Jejejeje, soy todo un artista. Cuando quieras te espero en el laboratorio para que baiiilemos juntos.')
posLA.positionMove(yarp.DVector(la))
posRA.positionMove(yarp.DVector(ra))
while not (posLA.checkMotionDone() and posRA.checkMotionDone() and tts.checkSayDone()):
    sleep(0.1)
