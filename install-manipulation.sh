...
sudo apt update
echo -e "Updating system... \e[92m[ok]"
...
echo -e "echo Installing yarp... \e[92m[ok]"
...
make -j$(nproc)  # compile
sudo make install && sudo ldconfig && cd # Install and go home
echo -e "Installing Python bindings... \e[92m[ok]"
...
echo -e "Installing color debug... \e[92m[ok]"
...
echo -e "Installing yarp-devices... \e[92m[ok]"
...
sudo make install
echo -e "Installing teo-configuration-files... \e[92m[ok]"
echo -e "Installation \e[5m completed successfully"
